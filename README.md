...
*   **Card Management**:
    *   **Create**: Add new cards with a Category, Front (Question), and Back (Answer).
    *   **Delete**: Remove cards you no longer need.
    *   **Import**: Bulk upload cards using a JSON file.
...
You can bulk import cards by uploading a `.json` file. The file should contain a list of objects with `category`, `front`, and `back` keys.
